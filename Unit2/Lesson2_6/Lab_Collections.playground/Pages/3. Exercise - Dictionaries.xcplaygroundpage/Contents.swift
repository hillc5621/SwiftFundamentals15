 ...
 */
var Dictionary = ["January": 31, "Febuary": 28, "March": 31]
print(Dictionary)
...
if let DictionaryJanuary = Dictionary["January"] {
    print("January has" , DictionaryJanuary , "days")
}
    


//:  Given the following arrays, create a new [String : [String]] dictionary. `shapesArray` should use the key "Shapes" and `colorsArray` should use the key "Colors." Print the resulting dictionary.
let shapesArray = ["Sqaure", "Triangle", "Circle"]
let colorsArray = ["Yellow", "Blue", "Green"]
