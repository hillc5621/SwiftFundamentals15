 ...
 */
var Walkingchallenges: [String] = ["Walk 1 mile", "Walk for 10 mins"]
var Runningchallenges: [String] = ["Run 2 miles", "Run for 20 mins"]
...
challenges.insert(contentsOf: Walkingchallenges, at: 0)
challenges.insert(contentsOf: Runningchallenges, at: 2)
print(challenges[2])
...
var Committedchallenges: [String] = ["Running 1 Mile"]
