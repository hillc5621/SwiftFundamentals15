...
let somePlace = GPS(latitude: 51.514004, longitute: 0.125226)
...
var favoriteBook = Book(title: "World War Z", author: "Max Brooks", pages: 341, price: 15.0)
print("My favorite book is ",favoriteBook.title,"it is written by",favoriteBook.author,", It has",favoriteBook.pages,"pages and costs $",favoriteBook.price)
/*:
...
var Laptop1 = Laptop(yearPurchased: 1999)
var Laptop2 = Laptop(yearPurchased: 2004)
