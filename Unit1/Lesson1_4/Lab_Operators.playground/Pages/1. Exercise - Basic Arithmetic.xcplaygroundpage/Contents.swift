...
let integerDivisionResult = 10 / 3 //The expected result would be 3.3333
...
print(divisionResult) //It differs because doubles allow for deciaml points while integers do not
/*:
...
print(odd % 2)
print(even % 2)
// If the number that is being divided has a remainder then it is a odd number
/*:
